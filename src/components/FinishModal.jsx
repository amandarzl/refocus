        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-1 text-sm italic text-ink-secondary">
              Add a snapshot and notes to remember this session by — your
              progress is already saved either way. (optional)
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="mt-6 flex flex-col gap-5">
          ...
          <div>
            ...
            {image ? (
              ...
              >
                ...
                <span className="text-sm font-medium">Upload snapshot</span>
              </EmptyTile>
            )}
            <input
              ref={fileInputRef}
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full resize-none rounded-panel border border-border bg-surface-sunken px-4 py-3 text-sm text-ink-primary placeholder:italic placeholder:text-ink-muted outline-none transition-colors focus:border-accent-primary"
            />
          </div>
          ...
          <div className="flex gap-3">
            ...
            <Button
              variant="primary"
              onClick={handleSave}
              className="flex-1 justify-center py-3 shadow-card"
            >
              Done
            </Button>
          </div>
